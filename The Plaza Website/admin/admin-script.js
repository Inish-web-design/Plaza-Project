...
class PlazaCMS {
            ...
            <div class="event-item" data-event-id="${event.id}">
                <div class="event-header">
                    ...
                    <div class="event-actions">
                        <button class="edit-btn" onclick="cms.editEvent(${event.id})">Edit</button>
                        <button class="delete-btn" onclick="cms.deleteEvent(${event.id})">Delete</button>
                    </div>
                </div>
    ...
    bindEventActions() {
        // Event actions are bound via onclick in the HTML for simplicity
    ...
    async saveEvent(e) {
        ...
        if (eventData.date) {
            ...
            console.log('Event date:', eventData.date, 'Parsed as:', dateCheck);
        }
    ...
    saveToStorage() {
        localStorage.setItem('plazaEvents', JSON.stringify(this.events));
...
// Make CMS available globally for easy debugging
